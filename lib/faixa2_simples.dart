...
class Faixa2Simples extends StatelessWidget {
   final double itu;

  const Faixa2Simples({Key? key, required this.itu}) : super(key: key);
        ...
        body: SafeArea(
            child: Column(
              ...
              Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(15)), color: Color.fromRGBO(234,	255,	71, 1)),
                  margin: EdgeInsets.only(bottom: screenHeight * .05),
                  child: Center(
                    child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  Container(height: screenHeight*.1, child: new Image.asset("assets/cuidado.png")),
                  SizedBox(width: size.width*.05),
                  Container(child: Text("ATENÇÃO!", style: TextStyle(fontSize: 25.sp, fontWeight: FontWeight.w800)))
                ]))),
